...
#define LSR_RFE                 (1 << 7)	/* FIFO Error Status */
...
/* UART 16550 */
#define IER_TXTH		(1 << 1)	/* Enable Transmitter Empty Interrupt */
#define IER_RXTH		(1 << 0)	/* Enable Received Data Available Interrupt */
